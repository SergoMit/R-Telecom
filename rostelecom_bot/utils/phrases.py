...
- Команда /get_data отправляет пользовательский запрос хранилищу, содержащемуся на 
Яндекс.Диске, и выводит в чат соответствующие данные.

- Команда /help содержит всю необходимую информацию о чат-боте (Вы сейчас здесь).

- Команда /quit завершает текущую сессию с чат-ботом.
"""
